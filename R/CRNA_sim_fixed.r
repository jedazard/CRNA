...
#==========================================================================================#
#save.image(file=file.path(HOME.path, RESULT.path, "CRNA_SIMS_fixed.RData", fsep=.Platform$file.sep))

#==========================================================================================#
# Load the workspace
#==========================================================================================#
load(file=file.path(HOME.path, RESULT.path, "CRNA_SIMS_fixed.RData", fsep=.Platform$file.sep))
...
my.file <- file.path(HOME.path, NATM.path, "SuppFigure02.ps", fsep=.Platform$file.sep)
...
my.file <- file.path(HOME.path, NATM.path, "SuppFigure04.ps", fsep=.Platform$file.sep)
...
my.file <- file.path(HOME.path, NATM.path, "SuppFigure06.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
#==========================================================================================#
# SUPPORTING FIGURE 08:
# Effect of Affinity Scores Fold Change
#==========================================================================================#
my.file <- file.path(HOME.path, NATM.path, "SuppFigure08.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
# Effect of Frequency of Occurrence in Replications 
#==========================================================================================#
my.file <- file.path(HOME.path, NATM.path, "SuppFigure10.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
# Effect of Procedural Replications
#==========================================================================================#
my.file <- file.path(HOME.path, NATM.path, "SuppFigure12.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
my.file <- file.path(HOME.path, NATM.path, "SuppFigure14.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
for (depth in depth.levels) {
  write.table(CRNA.output[[depth]][[f]]$edges, 
              file.path(HOME.path, NATM.path, paste("SuppFigure16_edgelist,depth=", depth, ",fdr=", format(x=fdr.set[f], nsmall=2, scientific=TRUE), ".txt", sep=""), fsep=.Platform$file.sep),
              quote=FALSE, 
              row.names=FALSE, 
              sep="\t")
  ...
  write.table(nodelist, 
              file.path(HOME.path, NATM.path, paste("SuppFigure16_nodelist,depth=", depth, ",fdr=", format(x=fdr.set[f], nsmall=2, scientific=TRUE), ".txt", sep=""), fsep=.Platform$file.sep), 
              quote=FALSE, 
              row.names=FALSE, 
              sep="\t")
}

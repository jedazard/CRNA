...
#==========================================================================================#
#save.image(file=file.path(HOME.path, RESULT.path, "CRNA_SIMS_ascending_largekb.RData", fsep=.Platform$file.sep))

#==========================================================================================#
# Load the workspace
#==========================================================================================#
load(file=file.path(HOME.path, RESULT.path, "CRNA_SIMS_ascending_largekb.RData", fsep=.Platform$file.sep))
...
Depth: 1
Median degree (\nu): 3
Median path length (\lambda): 8.47
e/p: 1.78560223113
...
Depth: 1
Median degree (\nu): 3
Median path length (\lambda): 10.81
e/p: 1.86104075524

...
#==========================================================================================#
#save.image(file=file.path(HOME.path, RESULT.path, "CRNA_SIMS_descending.RData", fsep=.Platform$file.sep))

#==========================================================================================#
# Load the workspace
#==========================================================================================#
load(file=file.path(HOME.path, RESULT.path, "CRNA_SIMS_descending.RData", fsep=.Platform$file.sep))
...
rm(depth, inter_names, nodes_names)
...
#===============================================================================================================================#
# MANUSCRIPT SUPPORTING FIGURES
#===============================================================================================================================#

#==========================================================================================#
# SUPPORTING FIGURE 01:
# PE surface as a function of size and restart probability alpha, for fixed FDR, at each depth
#==========================================================================================#
f <- 1     # fixed DE FDR = 1e-2

my.file <- file.path(HOME.path, NATM.path, "SuppFigure01.ps", fsep=.Platform$file.sep)
...
# Empirical PEs vs. Optimal AUCs as a function of restart probability alpha, for fixed size q and FDR
#==========================================================================================#
f <- 1   # fixed DE FDR = 1e-2
q <- 1     # fixed size qm of maximum variance

my.file <- file.path(HOME.path, NATM.path, "SuppFigure03.ps", fsep=.Platform$file.sep)
...
# Empirical PEs vs. Optimal AUCs as a function of size q, for fixed restart probability alpha and FDR 
#==========================================================================================#
f <- 1   # fixed DE FDR = 1e-2

my.file <- file.path(HOME.path, NATM.path, "SuppFigure05.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
#==========================================================================================#
# SUPPORTING FIGURE 07:
# Effect of Affinity Scores Fold Change
#==========================================================================================#
my.file <- file.path(HOME.path, NATM.path, "SuppFigure07.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
#==========================================================================================#
# SUPPORTING FIGURE 09:
# Effect of Frequency of Occurrence in Replications 
#==========================================================================================#
my.file <- file.path(HOME.path, NATM.path, "SuppFigure09.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
# Effect of Procedural Replications
#==========================================================================================#
my.file <- file.path(HOME.path, NATM.path, "SuppFigure11.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
my.file <- file.path(HOME.path, NATM.path, "SuppFigure13.ps", fsep=.Platform$file.sep)
postscript(file=my.file, horizontal=FALSE, width=8.5, height=5, paper="special")
...
for (depth in depth.levels) {
  plot.heatmap(crna=CRNA.output[[depth]][[f]],
               ...
               score.paletteLength=c(51,51,51,51)[depth],
               express.paletteLength=c(100,100,100,100)[depth],
...
for (depth in depth.levels) {
  write.table(CRNA.output[[depth]][[f]]$edges, 
              file.path(HOME.path, NATM.path, paste("SuppFigure15_edgelist,depth=", depth, ",fdr=", format(x=fdr.set[f], nsmall=2, scientific=TRUE), ".txt", sep=""), fsep=.Platform$file.sep),
              quote=FALSE, 
              row.names=FALSE, 
              sep="\t")
  ...
  write.table(nodelist, 
              file.path(HOME.path, NATM.path, paste("SuppFigure15_nodelist,depth=", depth, ",fdr=", format(x=fdr.set[f], nsmall=2, scientific=TRUE), ".txt", sep=""), fsep=.Platform$file.sep), 
              quote=FALSE, 
              row.names=FALSE, 
              sep="\t")
}

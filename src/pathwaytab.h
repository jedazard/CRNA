...
private:
  ...
  PathwayTab(DataFrame pathwayDf1, DataFrame pathwayDf2,istream& imap_stream,istream& dogma_stream, const PropertySet& props);
public:
  static PathwayTab create(DataFrame pathwayDf1, DataFrame pathwayDf2,
    ...
    //return PathwayTab::PathwayTab(Rcpp::DataFrame pathwayDf1, Rcpp::DataFrame pathwayDf2, *imap_stream, *dogma_stream, props);
    return PathwayTab(pathwayDf1, pathwayDf2, *imap_stream, *dogma_stream, props);
  }

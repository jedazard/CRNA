...
r1_RWR0.65_DFS_graph <- RWR_dfs("ESR1",significant_genes_graph,miarray)
...
GSE11352_ESR1_graph <- graph_from_data_frame(unique(FC1.5_undirected_RWR0.65_JTREE_edgeList),directed = T)
...
GSE11352_ESR1_edge_part[which(GSE11352_ESR1_edge_part$sign == -1),3] <- "-t|"
# write.table(GSE11352_ESR1_node_part,paste0("output_for_significant/RWR_for_JTREE/JTREE_input/GSE11352_ESR1_pathway.tab"),row.names = F,col.names = F,quote = F,sep = "\t")
# write.table(GSE11352_ESR1_edge_part,paste0("output_for_significant/RWR_for_JTREE/JTREE_input/GSE11352_ESR1_pathway.tab"),row.names = F,col.names = F,quote = F,sep = "\t",append = T)
...
# write.table(rbind(id = colnames(GSE11352_ESR1_GSE11352_for_JTREE_genome),GSE11352_ESR1_GSE11352_for_JTREE_genome),paste0("output_for_significant/RWR_for_JTREE/JTREE_input/GSE11352_ESR1_GSE11352_genome.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
# write.table(rbind(id = colnames(GSE11352_ESR1_GSE11352_for_JTREE_mRNA),GSE11352_ESR1_GSE11352_for_JTREE_mRNA), paste0("output_for_significant/RWR_for_JTREE/JTREE_input/GSE11352_ESR1_GSE11352_mRNA.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
...
# write.table(GSE11352_ESR1_permuted_for_JTREE_genome,paste0("output_for_significant/RWR_for_JTREE/JTREE_input/GSE11352_ESR1_permuted_genome.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
# write.table(GSE11352_ESR1_permuted_for_JTREE_mRNA, paste0("output_for_significant/RWR_for_JTREE/JTREE_input/GSE11352_ESR1_permuted_mRNA.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
...
# Load JTREE results
RWR_GSE11352 <- read.table("output_for_significant/RWR_for_JTREE/JTREE_output/GSE11352_ESR1_GSE11352.txt",comment.char = ">")
RWR_permuted <- read.table("output_for_significant/RWR_for_JTREE/JTREE_output/GSE11352_ESR1_permuted.txt",comment.char = ">")

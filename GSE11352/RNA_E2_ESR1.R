...
GSE11352_exprs_for_PARADIGM <- read.csv("data_for_markdown/GSE11352_scaled_exprs.csv",row.names = 1)
...
#########################  DFS   ################################################################
FC1.5_undirected_RWR0.75_PARADIGM_candidates <- c()
FC1.5_undirected_RWR0.75_PARADIGM_edgeList <- as.data.frame(matrix(NA,nrow = 0,ncol = 4),row.names = c("from","to","sign","weight"))

r1_RWR0.75_DFS_graph <- RWR_dfs("ESR1",significant_genes_graph,miarray)
FC1.5_undirected_RWR0.75_PARADIGM_edgeList <- rbind(FC1.5_undirected_RWR0.75_PARADIGM_edgeList,
                                                    igraph::as_data_frame(r1_RWR0.75_DFS_graph))

GSE11352_ESR1_graph <- graph_from_data_frame(unique(FC1.5_undirected_RWR0.75_PARADIGM_edgeList),directed = T)
...
GSE11352_ESR1_edge_part[which(GSE11352_ESR1_edge_part$sign == -1),3] <- "-t|"
# write.table(GSE11352_ESR1_node_part,paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_pathway.tab"),row.names = F,col.names = F,quote = F,sep = "\t")
# write.table(GSE11352_ESR1_edge_part,paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_pathway.tab"),row.names = F,col.names = F,quote = F,sep = "\t",append = T)

### expression part
GSE11352_ESR1_GSE11352_exprs_for_PARADIGM <- GSE11352_exprs_for_PARADIGM[as.character(GSE11352_ESR1_node_part$id),]
rownames(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM) <- as.character(GSE11352_ESR1_node_part$id)
GSE11352_ESR1_GSE11352_for_PARADIGM_mRNA <- as.data.frame(t(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM))
GSE11352_ESR1_GSE11352_for_PARADIGM_genome <- GSE11352_ESR1_GSE11352_for_PARADIGM_mRNA
GSE11352_ESR1_GSE11352_for_PARADIGM_genome[,] <- NA

# write.table(rbind(id = colnames(GSE11352_ESR1_GSE11352_for_PARADIGM_genome),GSE11352_ESR1_GSE11352_for_PARADIGM_genome),paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_GSE11352_genome.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
# write.table(rbind(id = colnames(GSE11352_ESR1_GSE11352_for_PARADIGM_mRNA),GSE11352_ESR1_GSE11352_for_PARADIGM_mRNA), paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_GSE11352_mRNA.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
# write.table(paste0("/usr/bin/time /home/zaza/sbenz-Paradigm-c5fc0f9/paradigm -c  /home/zaza/sbenz-Paradigm-c5fc0f9/em_simple.cfg -p Jan25_GSE11352_ESR1_pathway.tab -b Jan25_GSE11352_ESR1_GSE11352 > ../PARADIGM_output/Jan25_GSE11352_ESR1_GSE11352.txt\n\n"),paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_PARADIGM.sh"),quote = F,row.names = F,col.names = F)

# Permuting Sample
GSE11352_ESR1_permuted_exprs_for_PARADIGM <- as.data.frame(matrix(NA,ncol = 0,nrow = nrow(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM)))
rownames(GSE11352_ESR1_permuted_exprs_for_PARADIGM) <- rownames(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM)
for (i in 1:ncol(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM)) {
  for (j in 1:1000) {
    GSE11352_ESR1_permuted_exprs_for_PARADIGM <- cbind(GSE11352_ESR1_permuted_exprs_for_PARADIGM,
                                                       GSE11352_ESR1_GSE11352_exprs_for_PARADIGM[sample(1:nrow(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM), 
                                                                                                        size = nrow(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM), replace = T),i])
  }    
}
GSE11352_ESR1_permuted_exprs_for_PARADIGM <- cbind(id = rownames(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM),GSE11352_ESR1_permuted_exprs_for_PARADIGM)
rownames(GSE11352_ESR1_permuted_exprs_for_PARADIGM) <- as.character(GSE11352_ESR1_permuted_exprs_for_PARADIGM$id)
colnames(GSE11352_ESR1_permuted_exprs_for_PARADIGM) <- c("id",1:(ncol(GSE11352_exprs_for_PARADIGM)*1000))
GSE11352_ESR1_permuted_for_PARADIGM_mRNA <- as.data.frame(t(GSE11352_ESR1_permuted_exprs_for_PARADIGM))
GSE11352_ESR1_permuted_for_PARADIGM_genome <- GSE11352_ESR1_permuted_for_PARADIGM_mRNA
GSE11352_ESR1_permuted_for_PARADIGM_genome[-1,] <- NA
# write.table(GSE11352_ESR1_permuted_for_PARADIGM_genome,paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_permuted_genome.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
# write.table(GSE11352_ESR1_permuted_for_PARADIGM_mRNA, paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_permuted_mRNA.tab"),sep = "\t",quote = FALSE,col.names = FALSE)
# write.table(paste0("/usr/bin/time /home/zaza/sbenz-Paradigm-c5fc0f9/paradigm -c  /home/zaza/sbenz-Paradigm-c5fc0f9/em_simple.cfg -p Jan25_GSE11352_ESR1_pathway.tab -b Jan25_GSE11352_ESR1_permuted > ../PARADIGM_output/Jan25_GSE11352_ESR1_permuted.txt\n\n"),paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/Jan25_GSE11352_ESR1_PARADIGM.sh"),quote = F,append = T,row.names = F,col.names = F)
# 


# 
# system(paste0("chmod +x output_for_significant/RWR_for_PARADIGM/PARADIGM_input/GSE11352_ESR1_PARADIGM.sh"))
# system(paste0("output_for_significant/RWR_for_PARADIGM/PARADIGM_input/GSE11352_ESR1_PARADIGM.sh"))
# system(paste0("rm -r output_for_significant/RWR_for_PARADIGM/PARADIGM_input/GSE11352_ESR1_PARADIGM.sh") )
...
permuted_activity_score <- as.data.frame(matrix(NA,nrow = nrow(RWR_permuted)/(ncol(GSE11352_ESR1_permuted_exprs_for_PARADIGM)-1),ncol = (ncol(GSE11352_ESR1_permuted_exprs_for_PARADIGM)-1)))
rownames(permuted_activity_score) <- RWR_permuted$V1[1:(nrow(RWR_permuted)/(ncol(GSE11352_ESR1_permuted_exprs_for_PARADIGM)-1))]
for (l in 1:(ncol(GSE11352_ESR1_permuted_exprs_for_PARADIGM)-1)) {
  tails <- l*(nrow(RWR_permuted)/(ncol(GSE11352_ESR1_permuted_exprs_for_PARADIGM)-1))
  heads <- tails-(nrow(RWR_permuted)/(ncol(GSE11352_ESR1_permuted_exprs_for_PARADIGM)-1)-1)
  permuted_activity_score[,l] <- as.numeric(RWR_permuted[heads:tails,2])
}

GSE11352_activity_score <- as.data.frame(matrix(NA,nrow = nrow(RWR_GSE11352)/(ncol(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM)),
                                                ncol = (ncol(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM))))
rownames(GSE11352_activity_score) <- RWR_GSE11352$V1[1:(nrow(RWR_GSE11352)/(ncol(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM)))]
for (m in 1:(ncol(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM))) {
  tails <- m*nrow(RWR_GSE11352)/(ncol(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM))
  heads <- tails-(nrow(RWR_GSE11352)/(ncol(GSE11352_ESR1_GSE11352_exprs_for_PARADIGM))-1)
